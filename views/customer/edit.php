	...
	<div class="container">
		<form action="?mod=customer&act=update" method="POST" role="form">
			...
			<div class="form-group">
				...
				<input type="text" readonly class="form-control" id="" placeholder="" name="MaKH" value="<?= $customer['MaKH']?>">
			</div>

			<div class="form-group">
				<label for="">Tên KH</label>
				<input type="text" class="form-control" id="" placeholder="" name="TenKH" value="<?= $customer['TenKH']?>">
			</div>

			<div class="form-group">
				<label for="">SĐT</label>
				<input type="text" class="form-control" id="" placeholder="" name="SDT" value="<?= $customer['SDT']?>">
			</div>

			<div class="form-group">
				<label for="">Email</label>
				<input type="email" class="form-control" id="" placeholder="" name="Email" value="<?= $customer['Email']?>">
			</div>

			<div class="form-group">
				<label for="">Địa chỉ</label>
				<input type="text" class="form-control" id="" placeholder="" name="DiaChi" value="<?= $customer['DiaChi']?>">
			</div>
