		...
		<table class="table table-bordered">
			...
			<?php foreach ($data as $row) { ?>
				<tr>
					...
					<td align="center">
						<a href="index.php?mod=customer&act=detail&MaKH=<?php echo $row['MaKH']; ?>" title="" class="btn btn-success">Xem chi tiết</a>
						<a href="index.php?mod=customer&act=edit&MaKH=<?php echo $row['MaKH']; ?>" title="" class="btn btn-primary">Sửa</a>
						<a href="index.php?mod=customer&act=delete&MaKH=<?php echo $row['MaKH']; ?>"  onclick="return confirm('Are you sure?')" title="" class="btn btn-danger">Xóa</a>
					</td>
				</tr>
