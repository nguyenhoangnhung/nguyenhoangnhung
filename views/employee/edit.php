	...
	<div class="container">
		<form action="?mod=employee&act=update" method="POST" role="form">
			...
			<div class="form-group">
				...
				<input type="text" readonly class="form-control" id="" placeholder="" name="MaNV" value="<?= $employee['MaNV']?>">
			</div>

			<div class="form-group">
				<label for="">Tên NV</label>
				<input type="text" class="form-control" id="" placeholder="" name="TenNV" value="<?= $employee['TenNV']?>">
			</div>

			<div class="form-group">
				<label for="">Email</label>
				<input type="email" class="form-control" id="" placeholder="" name="Email" value="<?= $employee['Email']?>">
			</div>

			<div class="form-group">
				<label for="">SĐT</label>
				<input type="text" class="form-control" id="" placeholder="" name="SDT" value="<?= $employee['SDT']?>">
			</div>

			<div class="form-group">
				<label for="">Mật khẩu</label>
				<input type="password" class="form-control" id="" placeholder="" name="MatKhau" value="<?= $employee['MatKhau']?>">
			</div>
